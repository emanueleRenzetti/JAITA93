...
public class ContoCorrente {
	...
	private static int contatore = 1; //static significa che è della classe , non degli oggetti. static lo posso mettere davqnti le proprietà e i metodi. 
	
	
	private int numero;
	public Cliente titolare; //proprietà conto corrente

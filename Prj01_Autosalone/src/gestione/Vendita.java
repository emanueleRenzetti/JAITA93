...
public class Vendita {
	...
	public static void main(String[] args) {
		...
		garage[4] = new Automobile("Ferrari", "GT500", 2020, 45550);
		...
		garage[9] = new Automobile("Bmw", "Serie5", 2018, 24550);
		...
		System.out.println("il valore totale del garage è: ");
...
//		per fare un commento evidenziando un testo si fa premendo ctrl + shift + 7 
